...
export default async (): Promise<Environment> => {
  ...
  return {
    ...
    GOOGLE_ONE_TAP_CLIENT_ID: process.env.GOOGLE_ONE_TAP_CLIENT_ID,
    ...
    ENABLE_MICROSOFT_OAUTH_REDIRECT:
      process.env.ENABLE_MICROSOFT_OAUTH_REDIRECT === 'true',
    ENABLE_SLACK_OAUTH_REDIRECT:
      process.env.ENABLE_SLACK_OAUTH_REDIRECT === 'true',
    ENABLE_GOOGLE_TOKEN_EXCHANGE:
      process.env.ENABLE_GOOGLE_TOKEN_EXCHANGE !== 'false',
